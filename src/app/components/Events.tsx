...
const Events: React.FC = () => {
  ...
  return (
    <section className="w-full py-16 bg-gradient-to-r from-gray-50 via-blue-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
          
          {/* Left Side - EVENTS Text with Background - Full Width */}
          <div className="lg:col-span-12 mb-2">
            <div 
              className="relative h-32 w-full rounded-xl overflow-hidden shadow-xl"
              style={{
                backgroundImage: "url('theme/images/footerBackground.jpg')",

...
import { getLeaderById } from "@/lib/leadershipData";
                ...
                <div className="max-w-7xl mx-auto px-6 pt-12 pb-6 ">
                    <div className="text-center">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center gap-2 px-6 py-2 mb-4 bg-theme-blue text-white rounded-lg hover:bg-theme-orange transition-colors duration-300"
                        >
